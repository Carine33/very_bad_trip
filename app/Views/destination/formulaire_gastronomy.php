<?php $this->layout('layout_evenement', ['title' => 'ajouter un plat']) ?>
            	...
            	<div class="row">
                	...
                	<div class="col-md-4 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="name_gastronomie">Nom du plat : </label>
                            <input type="text" class="form-control" id="name_gastronomy" name="name_gastronomy">
                            <p class="help-block text-danger"></p>
                        ...
                        <div class="form-group">
                            ...
                            <label for="name_gastronomy">Commentaire : </label>
