<?php $this->layout('layout_evenement', ['title' => 'Ajouter film']) ?>
            	...
            	<div class="row">
                	...
                	<div class="col-md-4 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="name_movie">Nom du film : </label>
                            <input type="text" id="name_movie" class="form-control" name="name_movie">
                            <p class="help-block text-danger"></p>
                        ...
                        <div class="form-group">
                            ...
                            <label for="commentaire_movie">Commentaire : </label>
