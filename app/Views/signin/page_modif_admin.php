					...
					<div class="row">
						...
						<div class="form-group">
								<div class="col-md-6">
									...
									<div class="radio">
										<label for="role-0">
										<input type="radio" name="role" id="role-0" value="admin" <?php if($users['role'] == 'admin'){?> checked <?php } ?>> Administrateur
										</label>
									</div>
									<div class="radio">
										<label for="role-1">
										<input type="radio" name="role" id="role-1" value="user"  <?php if($users['role'] == 'user'){?> checked <?php } ?>> Utilisateur
										</label>
									</div>
								</div>
						</div>
